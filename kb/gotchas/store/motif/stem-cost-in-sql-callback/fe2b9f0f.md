...
(Path note: `textnorm` is `internal/fact/textnorm` as of PR #191, moved unchanged from `internal/textnorm`; the benchmark invocation is `go test ./internal/fact/textnorm/ -bench ...`.)
